...
const Holiday = () => {
  ...
  const handleSearch = () => {
    ...
    navigate(`/search-packages?city=${toQuery}&date=${selectedDate}`);
  };
  ...
  return (
    <div className="relative bg-white rounded-2xl bottom-12 z-0 w-full p-6 shadow-xl py-18 transition-all duration-300 hover:shadow-2xl">
      <div className="grid grid-cols-4 divide-x divide-gray-100 border border-gray-200 rounded-2xl">
        ...
        {/* From City */}
        <div className="px-6 py-5 hover:bg-gray-50 transition-colors cursor-pointer group overflow-hidden relative">
          <p className="text-xs text-gray-500 uppercase tracking-widest mb-2 font-medium">From City</p>
        ...
        <div className="px-6 py-5 hover:bg-gray-50 transition-colors cursor-pointer group relative">
          ...
          {activeField === 'to' && (
            <div ref={dropdownRef} className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-300 rounded-xl shadow-2xl  z-[1000] max-h-60 overflow-y-auto w-3/5">
        ...
        {/* Departure Date */}
        <div className="relative px-6 py-5 hover:bg-gray-50 transition-colors group">
          <p className="text-xs text-gray-500 uppercase tracking-widest mb-2 font-medium">Departure Date</p>
          <input 
            type="date"
            className="w-full bg-transparent text-xl font-bold text-gray-900 cursor-pointer focus:outline-none"
